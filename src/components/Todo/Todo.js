...
class Todo extends React.Component {
  ...
  render() {
    ...
    return(
      <li
         className={style.TodoList + ' ' + (this.props.isDone ? style.doneTodo : '')}
         key={this.props.id}
         >
        <div>
          <span
          onClick={() => this.props.done(
            ...
            this.props.text,
            this.props.isDone)}>
            <i className={style.doneHover + ' ' + (this.props.isDone ? style.doneButton : '') + " fa fa-check-circle-o"} aria-hidden="true"></i>
          </span>
          <span href="#"
          onClick={() => this.props.remove(this.props.id)}>
            <i className={style.remove + " fa fa-minus-circle"} aria-hidden="true"></i>
          </span>
